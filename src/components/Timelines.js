...
const ChartComponent = (data) => (
  <HighchartsChart>
    ...
    {console.log(data)}
    <YAxis>
      <YAxis.Title>Block Count</YAxis.Title>
      <LineSeries name="Blocks" data={data.blocks} />
    </YAxis>
  </HighchartsChart>
)
...
class Timelines extends Component {
  render() {
    ...
    const blocks = data.map((e) => e.blockCount)

    return(
      <div>
        <ChartComponent dates={dates} blocks={blocks} />
      </div>
    )
  }
}

export default withHighcharts(Timelines, Highcharts)
